...
**Όριο ταυτόχρονων ανοιχτών θέσεων: `MAX_OPEN_POSITIONS = 3`.** Από την
ανάλυση των 174 trades φάνηκε ότι το bot μπορούσε να ανοίξει πολλά ζεύγη
*μαζί*, πριν προλάβει να κλείσει κάποιο από αυτά — σε μια συσχετισμένη
κίνηση αγοράς (π.χ. γενική πτώση) αυτό σήμαινε πολλές χαμένες θέσεις
ταυτόχρονα, χωρίς να προλάβει να αντιδράσει ο circuit breaker (που μετράει
ζημιές μόνο όταν *κλείνει* μια θέση). Τώρα, αν υπάρχουν ήδη 3 ανοιχτές
θέσεις, το bot δεν ανοίγει νέα — όσο καλό κι αν είναι το σκορ — μέχρι να
κλείσει μία από τις υπάρχουσες.
